    ...
    export default {
        ...
        methods:{
            deleteMovement(){
                ...
                const myIndex = this.$parent.$parent.$parent.ListtemporaryPackaging.indexOf(this.Packaging);
                console.log(myIndex);
                //this.$parent.ListPackaging.splice(myIndex,1);
                this.$parent.$parent.$parent.ListtemporaryPackaging.splice(myIndex,1);
