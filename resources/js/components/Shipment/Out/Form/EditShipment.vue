                                        ...
                                        <div class="row" >
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <v-select :options="ListStaff" :reduce="ListStaff => ListStaff.id " :label="ListStaff.label" v-model="Shipment.created_by"></v-select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 15px">
...
<script>
    export default {
        ...
        methods:{
            fetchStaff(){
                axios.get('/api/v1/Personnel/User/Lists/staff-list')
                    .then(function (response) {
                        this.ListStaff = $.map(response.data, function(value){
