<template>
    <div>
        <table id="dt-shipment-packaging-out" class="dt-shipment-packaging-out table table-bordered table-hover table-striped w-100">
...
<script>
    export default {
        ...
        methods: {
            updateTable(){
                if (this.dataTable) {
                    $('#dt-shipment-packaging-out').DataTable().destroy();
                }
                this.$nextTick(() =>
                {
                    this.dataTable = $('#dt-shipment-packaging-out').DataTable(
                        {
                            responsive: true,
