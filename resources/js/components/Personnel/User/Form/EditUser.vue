        ...
        <div class="modal-dialog modal-dialog-right">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title h3">{{this.User.name}}</h1>
                                    ...
                                    <div class="col text-left">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <v-select :options="ListCompanies" :reduce="ListCompanies => ListCompanies.id " :label="ListCompanies.label" v-model="User.company_id.id"></v-select>
                                            </div>
                                            <div class="form-group">
    ...
    export default {
        ...
        methods: {
            userChecked()
            {
                ...
                if(this.User.name && this.User.email && this.User.role && this.User.company_id.id)
                {
                    this.updateUser();
                }
            ...
            updateUser(){
                ...
                fetch(url, {
                    ...
                    body: JSON.stringify({
                        ...
                        role: this.User.role,
                        company_id: this.User.company_id.id,
