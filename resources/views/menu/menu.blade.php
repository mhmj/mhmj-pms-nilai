    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            <div class="info-card-text">
                <a href="{{route('profile')}}" class="d-flex align-items-center text-white">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="{{ (request()->routeIs('admin.shipment-in') || request()->routeIs('admin.shipment-out') || request()->routeIs('admin.DO-Summary'))   ? 'active' : '' }} ">
                ...
                <ul>
                    <li class="{{ (request()->routeIs('admin.DO-Summary')) ? 'active' : '' }} ">
                        <a href="{{route('admin.DO-Summary')}}"title="In" data-filter-tags="shipment in">
                            <span class="nav-link-text" data-i18n="nav.statistics_flot">D.O Summary</span>
                        </a>
                    </li>
                    <li class="{{ (request()->routeIs('admin.shipment-out')) ? 'active' : '' }} ">
                        <a href="{{route('admin.shipment-out')}}" title="Out" data-filter-tags="shipment out">
                            <span class="nav-link-text" data-i18n="nav.statistics_flot">Deliver</span>
                        </a>
                    </li>
                    <li class="{{ (request()->routeIs('admin.shipment-in')) ? 'active' : '' }} ">
                        <a href="{{route('admin.shipment-in')}}"title="In" data-filter-tags="shipment in">
                            <span class="nav-link-text" data-i18n="nav.statistics_flot">Receive</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            @if(Auth::user()->role == 'Customer')
                ...
                <li class="{{ (request()->routeIs('customer.company') || request()->routeIs('customer.user')) ? 'active' : '' }} ">
                    <a href="#" title="Personnel" data-filter-tags="personnel company user">
                        <i class="fal fa-building" style="color: #FFF"></i>
                        <span class="nav-link-text" data-i18n="nav.statistics_flot">Profile</span>
                    </a>
                    <ul>
                        <li class="{{ (request()->routeIs('customer.company')) ? 'active' : '' }} ">
                            <a href="{{route('customer.company')}}" title="Company" data-filter-tags="personnel company">
                                <span class="nav-link-text" data-i18n="nav.statistics_flot">Company</span>
                            </a>
                        </li>
                        <li class="{{ (request()->routeIs('customer.user')) ? 'active' : '' }} ">
                            <a href="{{route('customer.user')}}"title="User" data-filter-tags="personnel user">
                                <span class="nav-link-text" data-i18n="nav.statistics_flot">User</span>
                            </a>
                        </li>
                    </ul>
