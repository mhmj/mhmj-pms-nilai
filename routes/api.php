...
Route::group(['middleware' => 'api', 'prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::group(['prefix' => 'Report', 'as' => 'Report.', 'namespace' => 'Report'], function () {
        Route::group(['prefix' => 'Lists', 'as' => 'Lists.','namespace' => 'Lists'], function () {
            Route::get('/all-packaging', 'ListAllPackaging@allPackaging')->name('all-packaging');
            Route::get('{company_id}/company-packaging', 'ListCompanyPackaging@companyPackaging')->name('company-packaging');
            Route::get('/all-company-packaging', 'ListCompanyPackaging@AllCompanyPackaging')->name('all-company-packaging');
        });
    });
    ...
    Route::group(['prefix' => 'Packaging', 'as' => 'Packaging.', 'namespace' => 'Packaging'], function () {
        Route::group(['prefix' => 'Lists', 'as' => 'Lists.','namespace' => 'Lists'], function () {
            ...
            Route::get('{packaging_no}/list-packaging-details', 'ListPackagingDetails@list')->name('list-packaging-details');
            Route::get('{packaging_no}/status', 'ListPackagingDetails@statusPackage')->name('packaging-status');
        });
        Route::group(['prefix' => 'Updates', 'as' => 'Updates.','namespace' => 'Updates'], function () {
    ...
    Route::group(['prefix' => 'Shipment', 'as' => 'Shipment.', 'namespace' => 'Shipment'], function () {
        Route::group(['prefix' => 'Lists', 'as' => 'Lists.','namespace' => 'Lists'], function () {
            ...
            Route::get('customer/{id}/all', 'CustomerListShipment@list')->name('customer-shipment-all');
        });
        Route::group(['prefix' => 'Updates', 'as' => 'Updates.','namespace' => 'Updates'], function () {
    ...
    Route::group(['prefix' => 'Movement', 'as' => 'Movement.', 'namespace' => 'Movement'], function () {
        Route::group(['prefix' => 'Lists', 'as' => 'Lists.','namespace' => 'Lists'], function () {
            ...
            Route::get('customer/{id}/in/movement', 'ListMovement@CustomerListMovementIN')->name('customer-list-movement-in');
            Route::get('customer/{id}/out/movement', 'ListMovement@CustomerListMovementOUT')->name('customer-list-movement-out');
    ...
    Route::group(['prefix' => 'Personnel', 'as' => 'Personnel.', 'namespace' => 'Personnel'], function () {
        ...
        Route::group(['prefix' => 'Company', 'as' => 'Company.', 'namespace' => 'Company'], function () {
            Route::group(['prefix' => 'Lists', 'as' => 'Lists.','namespace' => 'Lists'], function () {
                ...
                Route::get('customer/{id}/company-details', 'ListCompany@CustomerCompanyDetails')->name('company-details');
        ...
        Route::group(['prefix' => 'User', 'as' => 'User.', 'namespace' => 'User'], function () {
            Route::group(['prefix' => 'Lists', 'as' => 'Lists.','namespace' => 'Lists'], function () {
                ...
                Route::get('/staff-list', 'ListUser@staffList')->name('staff-list');
            });
            Route::group(['prefix' => 'Creates', 'as' => 'Creates.','namespace' => 'Creates'], function () {
            ...
            Route::group(['prefix' => 'Updates', 'as' => 'Updates.','namespace' => 'Updates'], function () {
                ...
                Route::get('/check-password/{id}/{password}', 'UpdateUser@checkpassword')->name('check-password');
                Route::get('/{id}/{new_password}/change-password', 'UpdateUser@changePassword')->name('change-password');
            });
            Route::group(['prefix' => 'Deletes', 'as' => 'Deletes.','namespace' => 'Deletes'], function () {
